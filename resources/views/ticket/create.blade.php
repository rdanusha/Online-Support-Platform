...
@section('content')
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header">{{ __('Open a Ticket') }}</div>
                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ route('ticket.store') }}" novalidate>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input type="text" id="subject" value="{{ old('subject') }}" class="form-control @error('subject') is-invalid @enderror" name="subject" required >
                                    @error('subject')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
